...
KEYSTORE_FILENAME="zookeeper.server.keystore.jks"
VALIDITY_IN_DAYS=3650
DEFAULT_TRUSTSTORE_FILENAME="zookeeper.server.truststore.jks"
TRUSTSTORE_WORKING_DIRECTORY="/var/ssl/private"
KEYSTORE_WORKING_DIRECTORY="/var/ssl/private"
