...
-e  KAFKA_BROKER_ID=$2 -e TRUSTSTORE_WORKING_DIRECTORY=/var/ssl/private/kafka/kafka.broker.truststore.jks -e KEYSTORE_WORKING_DIRECTORY=/var/ssl/private/kafka/kafka.broker.keystore.jks \
