...
-v kafka_broker_kafka_config:/opt/kafka/config -e  KAFKA_ADVERTISED_HOST_NAME=$broker_ip -e KAFKA_ZOOKEEPER_CONNECT=zookeeper:2281 -e KAFKA_PORT=$1 -e KAFKA_ADVERTISED_PORT=$1 \
