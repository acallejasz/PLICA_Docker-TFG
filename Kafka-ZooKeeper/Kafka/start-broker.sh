...
(
    ...
    updateConfig "listeners" "$KAFKA_LISTENERS" "$KAFKA_HOME/config/server.properties"
    updateConfig "advertised.listeners" "$KAFKA_ADVERTISED_LISTENERS" "$KAFKA_HOME/config/server.properties"
