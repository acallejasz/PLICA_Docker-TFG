...
KEYSTORE_FILENAME=${ZOOKEEPER_KEYSTORE_FILENAME}
VALIDITY_IN_DAYS=3650
DEFAULT_TRUSTSTORE_FILENAME=${ZOOKEEPER_TRUSTSTORE_FILENAME}
TRUSTSTORE_WORKING_DIRECTORY=${ZOOKEEPER_STORE_WORKING_DIRECTORY}
KEYSTORE_WORKING_DIRECTORY=${ZOOKEEPER_STORE_WORKING_DIRECTORY}
CA_CERT_FILE="ca-cert-zookeeper"
KEYSTORE_SIGN_REQUEST="cert-file-zookeeper"
KEYSTORE_SIGN_REQUEST_SRL="ca-cert-zookeeper.srl"
KEYSTORE_SIGNED_CERT="cert-signed-zookeeper"
...
CN=${ZOOKEEPER_IP}
LOCATION=Madrid
PASS=${ZOOKEEPER_TRUSTSTORE_PASSWORD}
...
echo "Welcome to the Zookeeper SSL keystore and trust store generator script."
...
trust_store_private_key_file=""
  ...
  openssl req -new -x509 -keyout $TRUSTSTORE_WORKING_DIRECTORY/ca-key-zookeeper \
    -out $TRUSTSTORE_WORKING_DIRECTORY/ca-cert-zookeeper -days $VALIDITY_IN_DAYS -nodes \
    -subj "/C=$COUNTRY/ST=$STATE/L=$LOCATION/O=$OU/CN=$CN"

  trust_store_private_key_file="$TRUSTSTORE_WORKING_DIRECTORY/ca-key-zookeeper"
  ...
  keytool -keystore $TRUSTSTORE_WORKING_DIRECTORY/$DEFAULT_TRUSTSTORE_FILENAME \
    -alias CARoot -import -file $TRUSTSTORE_WORKING_DIRECTORY/ca-cert-zookeeper \
